...
$(document).ready(()=>{
    ...
    $('.video-play').mouseover(function(){
        ...
        $(this).parent().find('.play').html('<i class="bi bi-play-circle"></i>');
    })
    $('.video-play').mouseout(function(){
        $(this).parent().css("position","");
        $(this).parent().find('.play').html('');
    })
    $('.slide-main').slick({
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    $('.dark-view').click(function(){
        $(this).parent().find('.quick-view-container').css({"top":"-100%","opacity":"0.1"});
        $(this).fadeOut();
    })
    $('.video-play').click(()=>{
        $('.background-youtube').fadeIn();
        $('.popup-youtube-youtbe').css({"top":"10%","opacity":"1"});
        var a = $(this).find('.url').val();
    })
    $('.close-youtube').click(()=>{
        $('.background-youtube').fadeOut();
        $('.popup-youtube-youtbe').css({"top":"-100%","opacity":"0.1"});
    })
    $('.background-youtube').click(function(){
        $('.popup-youtube-youtbe').css({"top":"-100%","opacity":"0.1"});
        $(this).fadeOut();
    })
})